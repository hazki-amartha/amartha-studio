  ...
  return (
    ...
    >
      ...
      {worked ? (
        ...
        // take it over and sit with her instead — the application takeover the
        // reference draws between the self-service and assisted paths.
        <StickyBar>
          <Button
            size="lg"
            className="w-full"
          ...
          >
            Takeover jadi assisted
          </Button>
          <span className="text-center text-12 text-caption">Pandu calon mitra isi survey via APartner</span>
        </StickyBar>
      ) : lead.status === 'survey-created' && lead.surveyMode === 'assisted' ? (
        // An assisted survey already in progress — resume the checklist.
        <StickyBar>
