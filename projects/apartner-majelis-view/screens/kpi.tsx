...
// KPI — the four daily targets, behind a tab.
//
// Ported unchanged in intent from `apartner-task-first`, because the placement
// argument is the same one this direction makes: a BP carries four simultaneous
// daily targets and is measured on them, but a number on the working surface
// makes her synthesise before she can move. Behind a tab, it is something she
// checks when she wants to know how the day is going.
//
// So the page is deliberately READ-ONLY. No "kerjakan sekarang" next to a
// lagging metric — hang a task off a score and the score becomes the way you
// navigate work, which is the model `apartner-homepage-ia` explores instead.
// Here the schedule owns the work, and this page ends by pointing back at it.

import { Card } from '@/design-system/components'
import { Screen, TopBar } from '@/platform/primitives'
import { rupiah } from '../lib/data'
import { TASKS } from '../lib/schedule'
import { doneTaskList, useApp } from '../lib/store'
...
export function KpiScreen() {
  ...
  return (
    ...
    >
      ...
      <Overline>Pelayanan</Overline>
      <Card>
        <div className="flex items-center gap-12">
          <div className="flex min-w-0 flex-1 flex-col">
            <span className="text-14 font-bold text-default">Tugas selesai</span>
            <span className="text-12 text-caption">
              Semua target di atas bergerak dari pelayanan di Jadwal.
            </span>
          </div>
