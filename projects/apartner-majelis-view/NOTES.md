...
- **Quick filters on the collection roster** — Semua / Sudah ditagih / Belum ditagih, each carrying its count. "Who is left" is the question the stage is asked constantly, and it was being answered by scrolling the whole list looking for buttons. A filter, not a sort: the order underneath never moves.
