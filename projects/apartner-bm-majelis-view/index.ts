...
export const project: ProjectModule = {
  ...
  screens: [
    ...
    },
    {
      ...
      notes: [
        'The BM’s own account and settings — the standard shelf every app has, and deliberately unremarkable.',
        'KPI sits at the head of the menu here now that the bottom bar’s fourth slot is Sales rather than KPI — Profil is its way in.',
      ],
      flowsTo: [
        { to: 'kpi', label: 'KPI — baris teratas menu' },
        { to: 'today', label: 'tab Jadwal' },
        { to: 'majelis-list', label: 'tab Majelis' },
        { to: 'mitra-list', label: 'tab Mitra' },
        { to: 'sales', label: 'tab Sales' },
    ...
    },
    {
      ...
      notes: [
        'The branch’s lead pipeline, ported from the BP concept and given the axis this direction turns on: every lead — and every POI — is assigned to a BP or kept by the BM herself. The page splits on a segmented control into Leads and POI.',
        'Leads is the flat-status roster, with one line added under each name: who works her. On top of Status / Tipe / Sumber / Majelis there is a Petugas filter reading that field — “show me everything Sari is carrying”, or “what am I holding myself”.',
        'POI is the list of points of interest the BM plans and hands out — each a card she created, with its area, its assignee, and how many leads have come from it. The same Petugas filter narrows it. Tambah is context-aware: on Leads it adds a lead, on POI it adds a POI.',
      ],
      flowsTo: [
        { to: 'lead-detail', label: 'buka lead' },
        { to: 'lead-new', label: 'Tambah lead' },
        { to: 'poi-detail', label: 'buka POI' },
    ...
    },
    {
      ...
      notes: [
        'A prospect’s record. On top of the BP concept’s form it carries a Penugasan section — “Ditugaskan ke” — so the BM can hand the lead to a BP or take it back, at any status.',
      ],
      flowsTo: [{ to: 'lead-detail', label: 'perbarui status / tugaskan' }],
    },
    {
      id: 'lead-new',
      title: 'Tambah Lead',
