  ...
  screens: [
    ...
    },
    {
      ...
      notes: [
        ...
        'Payment is three named outcomes — [Tidak Bayar] [Jumlah Lain] [Bayar Lunas], primary last where the thumb lands. Bayar Lunas is the common case, so it costs one tap and no sheet. Jumlah Lain takes any amount, over or under. Tidak Bayar captures the reason and the promise to pay.',
