  ...
  screens: [
    ...
    },
    {
      ...
      notes: [
        ...
        'Identity, contact and the capital ladder are ONE card, not three stacked blocks. Three bordered blocks read as three ranked things to consider, which they never were — only the recommendation below is ranked. The groupings survive as hairline dividers inside the card.',
        'The ladder row carries its own conclusion in the subtitle, so a BP who never opens the screen still learns the fact. It does not repeat the word the badge already shows: badge says "Tertahan", subtitle says the number behind it.',
      ],
