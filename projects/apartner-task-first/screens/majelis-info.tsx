...
import { findMajelis, findMajelisEntry, rupiah } from '../lib/data'
import { IconPin, IconUsers } from '../lib/icons'
import { paymentStatus, recordedMembers, useApp } from '../lib/store'
import { Avatar, SectionTitle, StatRows } from '../lib/ui'
              ...
              <Card key={mitra.id}>
                <div className="flex items-center gap-12">
                  ...
                  <div className="flex min-w-0 flex-1 flex-col">
                    ...
                    <span className="text-12 text-caption">{rupiah(mitra.due)} per minggu</span>
                  </div>
