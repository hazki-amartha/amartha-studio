...
import {
  ...
  homeBMatrixBaik,
  homeBMatrixBuruk,
  homeBMatrixSangatBaik,
  homeBMatrixSangatBuruk,
  homeBMatrixSedang,
  lateCaught,
  neverWithdrew,
  newMitra,
  ...
  screens: [
    {
      ...
      states: [
        ...
        { id: 'hb-matrix-sangat-baik',  label: 'Matriks — Sangat Baik',  description: 'Pribadi 95% · Kelompok 95%. Nilai tertinggi, hadiah penuh.',                    apply: homeBMatrixSangatBaik  },
        { id: 'hb-matrix-baik',         label: 'Matriks — Baik',         description: 'Pribadi 95% · Kelompok ≤ 75%. Kelompok mulai tidak lancar, hadiah sedikit lebih kecil.', apply: homeBMatrixBaik        },
        { id: 'hb-matrix-sedang',       label: 'Matriks — Sedang',       description: 'Pribadi 50% · Kelompok ≤ 90%. Kelompok mulai perlu dijaga.',                    apply: homeBMatrixSedang      },
        { id: 'hb-matrix-buruk',        label: 'Matriks — Buruk',        description: 'Pribadi 50% · Kelompok ≤ 50%. Kelompok tidak lancar, hadiah turun tajam.',      apply: homeBMatrixBuruk       },
        { id: 'hb-matrix-sangat-buruk', label: 'Matriks — Sangat Buruk', description: 'Pribadi < 50% · Kelompok ≤ 30%. Nilai terendah, hadiah hangus.',                apply: homeBMatrixSangatBuruk },
