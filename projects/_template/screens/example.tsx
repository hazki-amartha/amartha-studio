...
//
// Wrap screen content in the <Screen> primitive (@/platform/primitives): pass
// the top bar via topBar, and Screen applies the neutral-50 canvas, 16px page
// padding, and 12px section gap for you. Use <TopBar> for screens that don't
// need a full NavigationHeader.
