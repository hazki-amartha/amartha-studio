 ...
 *  baru's lead funnel opened up ("With Leads monitoring"), or the same
 *  funnel broken down by NTB stage ("Pencairan: NTB detail"). */
export type PencairanVariant = 'default' | 'leads' | 'leads-detail'
