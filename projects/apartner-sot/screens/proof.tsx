...
//
// Two buttons, per the Figma: Kembali, and Simpan, which finishes the visit
// and hands straight to the WhatsApp preview, where she sends the group its receipt. That send used to be
...
import { MoneyBag, NotePencil } from '@/design-system/icons'
...
export function ProofScreen() {
  ...
  // through the app before she arrived (that money was never in her bag).
  ...
  return (
    ...
    >
      ...
      <Card>
        {/* Per the Figma: the cash figure alone. The room's breakdown already
            closed the Tagih stage ("N bayar • M tidak bayar"). */}
        ...
        <div className="flex flex-col gap-12">
          ...
          {s.photo ? (
            <>
              ...
              <Button variant="secondary" className="w-full" onClick={() => store.setPhoto(false)}>
      ...
      <StickyBar>
        ...
        {/* Kembali and Simpan, as the Figma draws every stage's footer. Saving
            hands straight to the WhatsApp preview, where the group's receipt is
            sent. */}
